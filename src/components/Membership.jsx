...
export const Membership = () => {
  return (
    ...
    >
      ...
      >
        <motion.span
          className="text-xs font-semibold uppercase tracking-[0.3em] text-brand-charcoal/60 "
          initial={{ opacity: 0 }}
      ...
      <motion.a
        href="#"
        className="mt-8 inline-flex items-center gap-3 rounded-full bg-brand-charcoal px-7 py-3 text-xs font-semibold uppercase tracking-[0.35em] text-white shadow-glass transition hover:-translate-y-0.5 hover:bg-brand-charcoal/90 dark:bg-white/15 md:mt-0"
        initial={{ x: 50, opacity: 0 }}
        whileInView={{ x: 0, opacity: 1 }}
